...
def eval_single_sample_iou_min(pred_bboxes, gt_bboxes, threshold=0.8):
...
def process_single_image_task(args_bundle):
    ...
    for run_idx, run_item in enumerate(runs_list):
        ...
        # Metrics Calculation
        p_min, r_min = eval_single_sample_iou_min(pred_bboxes, gt_bboxes, threshold=0.8)
        p_em, r_em = eval_single_sample_iou_em(pred_bboxes, gt_bboxes, threshold=0.6)
